...
class MyTheme {
  ...
  ThemeData light = ThemeData.light(useMaterial3: true).copyWith(
      ...
      bottomNavigationBarTheme: BottomNavigationBarThemeData(
        ...
        elevation: 5,
        selectedIconTheme:
            const IconThemeData(color: Colors.purple, opacity: 0.8),
      ...
      buttonTheme: const ButtonThemeData(
          colorScheme: ColorScheme.light(onSurface: Colors.purple)),
  ...
  ThemeData dark = ThemeData.dark(useMaterial3: true).copyWith(
      ...
      bottomNavigationBarTheme: BottomNavigationBarThemeData(
        ...
        elevation: 5,
        selectedIconTheme:
            IconThemeData(color: Colors.deepPurple.shade900, opacity: 0.8),
      ...
      buttonTheme: ButtonThemeData(
          colorScheme: ColorScheme.dark(onSurface: Colors.deepPurple.shade900)),
      textTheme: const TextTheme(
          bodyLarge: TextStyle(
        color: Colors.white,
        fontSize: 15,
